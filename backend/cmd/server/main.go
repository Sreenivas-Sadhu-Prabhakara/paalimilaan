// Command server runs the paalimilaan HTTP middleware.
package main
...
import (
	...
	"github.com/Sreenivas-Sadhu-Prabhakara/paalimilaan/backend"
)
...
func main() {
	...
	log.Printf("paalimilaan listening on %s", addr)
